...
//     mockUserService = MockUserService();
//
//     _chatsViewModel = ChatsViewModel(mockDatasource, mockUserService);
//   });
//
...
//     expect(await _chatsViewModel.getChats(), isEmpty);
//   });
//
...
//     final chats = await _chatsViewModel.getChats();
...
//         await _chatsViewModel.receivedMessage(message);
